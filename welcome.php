...
<h2 style="text-align:center;"><?php echo "Welcome ". $_SESSION['username']?>! You can now use this website</h2>
<hr>
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-7 mx-auto text-center" data-aos="fade-up">
                ...
                <p>??</p>
                <p><a href="Ethereum.php" class="btn btn-primary">Get Started</a></p>
              </div>
            </div>
          </div>
        </div>
